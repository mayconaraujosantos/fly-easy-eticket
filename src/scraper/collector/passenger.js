		...
		(TRIPS, PASSENGER) => {
			return [...document.querySelectorAll(TRIPS.ETICKET_CARD_BODY)].flatMap(
				(passenger) => {
					...
					const arrival = [
						{
							time: passenger.querySelector(TRIPS.ARRIVAL_TIME).innerText,
							location: passenger.querySelector(TRIPS.ARRIVAL_LOCATION)
								.innerText,
							airport: passenger.querySelector(TRIPS.ARRIVAL_AIRPORT).innerText,
						},
					];
							...
							return [
								{
									...
									airport: interruption.querySelector(TRIPS.AIRPORT).innerText,
									airlineCia: interruption.querySelector(TRIPS.AIRLINE_CIA)
										.innerText,
									flightNumber: interruption.querySelector(TRIPS.FLIGHT_NUMBER)
										.innerText,
									classService: interruption.querySelector(TRIPS.CLASS_SERVICE)
										.innerText,
